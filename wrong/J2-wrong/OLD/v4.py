    ...
    while not finishedsecondpart(weightcomparisons):
        ...
        while j < len(weightcomparisons):
            ...
            if takeapartresult == None:
                ...
                break
        if not done:
            weightcomparisons.append(outside)
...
b = chain(secondpart(firstpart(((5, 8),(7, 2),(8, 7),(3, 5),(7, 4),(1, 8),(1, 5),(3, 8),(5, 4),(3, 4),(4, 2),(6, 5),(1, 6),(1, 2),(6, 8)))))
print(b)
print(controll(((5, 8),(7, 2),(8, 7),(3, 5),(7, 4),(1, 8),(1, 5),(3, 8),(5, 4),(3, 4),(4, 2),(6, 5),(1, 6),(1, 2),(6, 8)), b))
