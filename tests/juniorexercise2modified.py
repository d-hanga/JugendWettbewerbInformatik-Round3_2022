...
class Biggest:
    @classmethod
    def go(cls, find, comparisons:list):
    ...
    @classmethod
    def biggest(cls, start, comparisonsoriginal:list[tuple]):
        ...
        while resulttmp:
            ...
            result = resulttmp[0]
            resulttmp = cls.go(result, comparisons)
        return result
    ...
    def process(cls, comparisons:list):
        old = None
        for comparison in comparisons:
            new = cls.biggest(comparison, comparisons)
